...
- 设置页支持创建和恢复最近的本机配置备份，用于回滚误删分类、工具或路径设置。
- 工具列表支持拖拽分类、自定义分类排序、已选工具批量移动分类。
- 侧栏保留更清晰的导航分组和开发者 GitHub 入口。
...
```text
src/App.tsx              主界面、工具目录、本机页、更新中心、设置页、日志中心 UI
...
发布时请确保 GitHub Release tag 与 `package.json` 版本一致，例如 `v0.6.1`。
